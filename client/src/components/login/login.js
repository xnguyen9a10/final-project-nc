...
class LoginComponent extends React.Component {
  ...
  render() {
    return (
      <div className="row justify-content-center" style={{backgroundColor: "#05588E"}}>
        <Helmet>
          <script
        ...
        <div className="card o-hidden shadow-0 border-0 my-5">
          <h1 style={{margin: "auto", marginTop: 10, marginBottom: 30, color: "white"}}>INTERNET BANKING</h1>
