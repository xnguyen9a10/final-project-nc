    ...
    render() {
        return (
            <div className="row justify-content-center login-page"
                ...
                <div className="card o-hidden border-0 shadow-lg my-5 login-warp"
                    style={{
                        backgroundImage: "url(https://lh3.googleusercontent.com/proxy/FDvdEPr-7la6-im3hsJjO-ButhBewABQtx8daMynhWypscjaWddOpprURQKasVXEBWH6oUxQAmIWgGrXS_1wLz2MmtKeENlosi33xT2RAw5btYtqD634PVgN7somSIRLkj9d_PKKUWCQGzXXcVLXBEgEKqo8_sbMBIphgYAQ" ,
                        backgroundRepeat: "no-repeat",
                        backgroundSize: "cover",
                        backgroundPosition: "center"
                    }}>
