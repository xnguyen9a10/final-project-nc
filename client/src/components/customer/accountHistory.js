...
class accountHistory extends React.Component {
    ...
    async componentDidMount(){
      ...
      const transferList = await httpClient.get(`/customer/transfer-history/${accountId}`);
      const receiveList = await httpClient.get(`/customer/receive-history/${accountId}`);
      const paymentList = await httpClient.get(`/customer/payment-history/${accountId}`);
